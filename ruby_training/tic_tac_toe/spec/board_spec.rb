  ...
  describe Board do
    ...
    context "grid" do
      it "returns the grid" do
        ...
        expect(board.grid).to eq "something"
      end
    end

    context "#set_cell" do
      it "updates value of cell object at (x, y) coordinates" do
    ...
    context "#game_over" do
      ...
      it "returns :winner when column has objects that have same value" do
        grid = [
          [x_cell, x_cell, empty],
          [y_cell, x_cell, y_cell],
          [y_cell, x_cell, empty]
